...
//                $this->set_pantalla('pant_persona');
	...
	//---- Filtro -----------------------------------------------------------------------
        ...
        function conf__filtro (toba_ei_filtro $filtro){
            ...
            $this->pantalla()->tab('pant_extra')->ocultar();
	...
	function evt__cuadro_personas__seleccionar ($datos)
	{
        ...
        function evt__filtro_busqueda__filtrar ($datos){
            ...
            $anio_lectivo=date('Y');
            $periodos=$this->dep('datos')->tabla('periodo')->get_listado($anio_lectivo);
...
//            }
        ...
        function cargar_form_periodo (toba_ei_formulario $form){
            ...
            $asignaciones=toba::db('gestion_aulas')->consultar($sql);
        ...
        /*
         * Nos lleva a la pantalla extras, donde veremos un calendario y un cuadro. 
         * Esta opcion se utiliza para agregar las fechas asociadas a una asignacion por periodo.
         */
...
//            }
        ...
        function get_establecimiento ($sigla){
            ...
            $establecimiento=toba::db('gestion_aulas')->consultar($sql);
