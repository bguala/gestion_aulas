...
include_once(toba_dir().'/proyectos/gestion_aulas/php/api/Filtro.php');
include_once(toba_dir().'/proyectos/gestion_aulas/php/api/Email.php');
...
class ci_solicitar_aula extends toba_ci
{
	...
	function conf__formulario(toba_ei_formulario $form)
	{
        ...
        function ajax__autocompletar_form ($legajo, toba_ajax_respuesta $respuesta){
            ...
            $datos_docente=toba::db('gestion_aulas')->consultar($sql);
...
//        }
        ...
        function obtener_facultades (){
            ...
            $facultades=toba::db('gestion_aulas')->consultar($sql);
            return $facultades;
        }
